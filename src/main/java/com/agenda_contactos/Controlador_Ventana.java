...
public class Controlador_Ventana {
    ...
    private void onBotonIngresarAction(){
        if(validarDatos()) {
            ...
            Mensajes.mensajeInformativo("", "El contacto "+ nombre + " fue agregado exitosamente");
            inputNombre.setText("");
            inputNumero.setText("");
        }
    }
    ...
    private void onBotonBorrarAction(){
        if(inputNombreBorrar.getText().isEmpty()){
            ...
            if(borrar==1){
                Mensajes.mensajeInformativo("", "El contacto "+ inputNombreBorrar.getText()+" fue eliminado correctamente");
            } else{
                Mensajes.mensajeInformativo("", "Contacto no encontrado");
            }
